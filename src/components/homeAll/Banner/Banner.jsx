            ...
            <div className={style.bannerfulldiv}>
                <div className='row'>
                    <div className='col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12'>
                        <div>
                            <div>
                                <h1 data-aos="zoom-in-right" className={style.bannerTeg}>There is <span className={style.alwaystext}>always</span> something new for us to learn</h1>
                            ...
                            <div className={style.bannerlowerpart}>
                                <button data-aos="zoom-in-right" className={style.bannerbtn}>Start Journey <span>
                                ...
                                <div className={style.bannerSVGdiv}>
                                    <span>
                    ...
                    <div className='col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12'>
                        <div className={style.bannerrightSidefull}>
                            <div className={style.bannerrightSide}>
                                <div data-aos="flip-up" className={style.bannercarddiv}>
                                    <div>
